...
qq.FineUploaderBasic.prototype = {
    ...
    _error: function(code, fileName){
        ...
        r('{0}', this._formatFileName(fileName));
        r('{1}', extensions);
        r('{2}', this._formatSize(this._options.validation.sizeLimit));
        r('{3}', this._formatSize(this._options.validation.minSizeLimit));
...
qq.FineUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' +
            ((!this._options.dragAndDrop || !this._options.dragAndDrop.disableDefaultDropzone) ? '<div class="qq-upload-drop-area' + (this._options.dragAndDrop.hideDropzones ? ' hide' : '') + '"><p><span>{dragZoneText}</span></p>' : '') +
            ((!this._options.button && !this._options.dragAndDrop.hideDropzones) ? '<div class="qq-upload-button"><div>{uploadButtonText}</div></div>' : '') +
            ((!this._options.dragAndDrop || !this._options.dragAndDrop.disableDefaultDropzone) ? '</div>' : '') + 
            ((!this._options.button && this._options.dragAndDrop.hideDropzones) ? '<div class="qq-upload-button"><div>{uploadButtonText}</div></div>' : '') +
            (!this._options.listElement ? '<ul class="qq-upload-list"></ul>' : this._options.listElement),
