import { ElementRef, NgZone, MbscBase, AfterViewInit, OnDestroy, Observable, MbscOptionsService, EventEmitter } from './frameworks/angular';
...
export declare class MbscListviewSublist {
}
